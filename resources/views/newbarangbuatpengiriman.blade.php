        ...
        <div class="col m1"></div>
          <div class="col m10">
            <div class="card-panel">
              <div class="row">
                <div class="row">
                    <div class="col m12"><h5>List Pengiriman Bahan Jadi<a href=""><span></span></a><hr></h5></div>
                </div>
                <table border="1">
                <tr>
                    <th>Kode Barang</th>
                ...
                @foreach($databarang as $row)
                  ...
                  @if($row->kodekategoribarang == "KB001")
                    ...
                    @if(session()->get("cartpe"))
                      ...
                      @else
                        <td><a class="waves-effect waves-light btn modal-trigger left" href="{!! url('addtocartpengirimanbarang/'.$row->kodebarang); !!}">CHECK</a></td>
                      @endif
                    @else
                      <td><a class="waves-effect waves-light btn modal-trigger left" href="{!! url('addtocartpengirimanbarang/'.$row->kodebarang); !!}">CHECK</a></td>
                    @endif
